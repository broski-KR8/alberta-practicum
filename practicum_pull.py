...
WHAT IT DOES EACH RUN:
  1. Asks Google Places for counselling/therapy practices across Alberta.
...
# CONFIG
# ----------------------------------------------------------------------
# Alberta-wide: the script searches each of these places separately.
# (Searching "Alberta" as one lump returns poor results, so we cover the
# main population centres. Add or remove places freely.)
PLACES = [
    "Calgary, Alberta",
    "Edmonton, Alberta",
    "Red Deer, Alberta",
...
def main():
    ...
    print(f"Searching Google across {len(PLACES)} Alberta locations ...")
